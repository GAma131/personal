 ...
 *
 * Desafío adicional: ¿Puedes implementar una versión recursiva de la función que genere los primeros n números de la secuencia de Fibonacci? (Nota: una función recursiva es aquella que se llama a sí misma en su implementación. En este caso, la función recursiva llamaría a sí misma para calcular cada número de la secuencia de Fibonacci, en lugar de usar un bucle)
 *
